...
const orderUtiles_1 = require("../utils/orderUtiles");
const uuid_1 = require("uuid");
const addOrder = async (orderItemsArr, paymentMethod, totalPrice, userId) => {
    if (orderItemsArr && orderItemsArr.length === 0) {
        throw new Error('No order items');
    }
    else {
        const newOrderItems = (0, orderUtiles_1.changekeysfromSongIdToProduct)(orderItemsArr);
